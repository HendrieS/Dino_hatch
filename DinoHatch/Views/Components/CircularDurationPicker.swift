...
/// duration up to 59:59. One full lap of the circle covers the entire
/// range (0:00 at the top, sweeping clockwise up to just under 60:00),
/// same as how an analog clock hand has no "stop" at 12 — dragging past
/// the top wraps around, which is the expected feel for a dial like this
